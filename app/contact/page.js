    ...
    <div className='bg-purple-200 min-h-[80vh] p-15'>
      <div className='grid md:grid-cols-2 '>
          ...
          <div className='flex flex-col gap-4 items-center justify-center'>
            ...
            <p className='px-20 font-serif text-lg text-center'>Thank you for visiting ZipLinks! We’re here to help you make the most of our URL shortening service. Whether you have a question, need assistance, or just want to give us feedback, don’t hesitate to reach out!</p>
          </div>
      </div>
